...
[`@aws-sdk/client-service-catalog`](https://www.npmjs.com/package/@aws-sdk/client-service-catalog/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-catalog@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0cdWqY+nkl/jENQTKeRP2zbMNOv5SNofs4GPm4zARp4OeGSaStaDJRc9i8Wz1YXZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-service-catalog": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-catalog@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-catalog@3.344.0/index.min.mjs": "sha384-0cdWqY+nkl/jENQTKeRP2zbMNOv5SNofs4GPm4zARp4OeGSaStaDJRc9i8Wz1YXZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-service-catalog/blob/refs/tags/3.344.0/LICENSE
```
