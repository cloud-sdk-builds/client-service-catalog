...
[`@aws-sdk/client-service-catalog`](https://www.npmjs.com/package/@aws-sdk/client-service-catalog/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-catalog@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ox3ZJm9ujiDQnWLEdfe+dSBtByMk0KVsJJRrmw8ZReVneypdBhZPbCGCZO3iqsOl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-service-catalog": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-catalog@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-service-catalog@3.326.0/index.min.mjs": "sha384-Ox3ZJm9ujiDQnWLEdfe+dSBtByMk0KVsJJRrmw8ZReVneypdBhZPbCGCZO3iqsOl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-service-catalog/blob/refs/tags/3.326.0/LICENSE
```
